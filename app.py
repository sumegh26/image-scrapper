    ...
    if request.method == 'POST':
                try:
                    ...
                    for image_tag in image_tags:
                                ...
                                my_dic = {"index": image_url , "image_data":image_data}
                                img_mongo_data.append(my_dic)
                    ...
                    db = client['image-scrapper-db']
                    collection = db['img-coll']
                    collection.insert_many(img_mongo_data)
